    ...
    <footer className="bg-black text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          <div>
            <h3 className="text-2xl font-bebas-neue mb-4">Project Notes</h3>
          ...
          <div>
            <h4 className="text-xl font-bebas-neue mb-4">Product</h4>
          ...
          <div>
            <h4 className="text-xl font-bebas-neue mb-4">Company</h4>
            <ul className="space-y-2 font-georgia">
          ...
          <div>
            <h4 className="text-xl font-bebas-neue mb-4">Legal</h4>
            <ul className="space-y-2 font-georgia">
        ...
        <div className="border-t border-gray-800 pt-8 mt-8 text-center font-georgia text-gray-400">
          <p>© 2023 Project Notes. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
